...
console.log('=== DETECTANDO DISPOSITIVOS ANDROID / SAMSUNG EN THINKPAD ===');
const psScript = `
Get-CimInstance Win32_PnPEntity | Where-Object { $_.Name -match 'Samsung|Android|SM-' -or $_.HardwareID -match '04E8' } | Select-Object Name, DeviceID, Status | Format-Table -AutoSize
`;
