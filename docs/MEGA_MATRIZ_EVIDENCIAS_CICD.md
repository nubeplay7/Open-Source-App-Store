...
| **P3** | **Descarga Oficial APK** | APK oficial disponible con cabecera MIME adecuada y descarga directa en el sitio web | **✅ VERIFIED (200 OK)** | /downloads/com.civer.appstore-v1.0.4-release.apk | 22,637,696 bytes • Scheme v2+v3+v4 fs-verity | HEAD HTTP 200 con Content-Length: 22637696 |
...
| **P6** | **Compilación en la Nube** | Compilación reproducible con GitHub Actions y entrega automática a bot Telegram | **✅ VERIFIED (100%)** | GitHub Actions Run ID: 34472413346 | Build APK exitoso • Entrega a Telegram @EnviodeApkCompiladaBot | Actions Workflow build-apk.yml en Ubuntu Runner |
...
```json
{
  ...
  "releases": {
    "civer-app-store": {
      ...
      "fallbackDownloadUrl": "http://appstore.civer.cloud:3000/downloads/com.civer.appstore-v1.0.4-release.apk",
